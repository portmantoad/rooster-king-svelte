...
<style type="text/css">
  .layer {
    ...
    --columnWidth: calc(
      (var(--bodywidth) - (var(--colGap) * (var(--columns) + 1))) /
        var(--columns)
    );
    ...
    margin-left: calc(
      (
        ...
        (var(--columnWidth) * max((var(--colStartClean) - 2), 0)) +
        (var(--colGap) * (var(--colStartClean) - 1))
    );
    margin-right: calc(
      (
          var(--gutterWidth) *
        ...
        (var(--columnWidth) * max((var(--colEndClean) - 2), 0)) +
        (var(--colGap) * (var(--colEndClean) - 1))
    );
