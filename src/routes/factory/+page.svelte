  ...
  $: {
    if (mounted) {
      ...
      if (progress > 0.98) {
        ...
        noiseLevel = Math.min(Math.max((progress - 0.5) * 2, 0), 1);
        noiseVol = noiseLevel;
        laughVol = 1 - noiseVol;
      }
...
<BgTrack
  bind:audioRef={holdmusic}
  volume={laughVol}
  muted={laughMuted}
  playbackRate={speed}
  src="/img/factory/holdmusic"
/>
...
<div
  class="noizz"
  style={`--fps:36; --width:3rem; image-rendering: pixelated; mix-blend-mode: hard-light; opacity:${noiseLevel}; ${!noiseLevel ? "display:none;" : ""}`}
></div>
...
/*            --transform-y-end: -15lvh;*/
  ...
  <LayerWrap>
    ...
    <Layer
      ...
      style="
        ...
        "
    >
      <div style="color: #fff; letter-spacing: .2em; font-family: monospace;">
        Ingredients: Farm fresh arugula lettuce, organic whipping cream,
        ethically sourced corn flakes, hormone free human meat
      </div>
    </Layer>
  ...
  <LayerWrap toggleVis>
    <Layer overlap colEnd="10" y="0">
      <img
        src="/img/factory/streetend.jpg"
        style="width:100vw; height:140lvh; object-fit:cover;"
      />
    </Layer>
    ...
    <LayerWrap>
      <Layer
        colEnd="11"
        overlap
        style=" mix-blend-mode: multiply; z-index: 10;"
      >
    ...
    <LayerWrap>
      <Layer colStart="5" colEnd="14">
        <img
          src="/img/factory/scribbles.jpg"
          style="width:100vw; min-height:100lvh; object-fit:cover; object-position: top;"
        />
      </Layer>
      <Layer
        overlap
        ...
        colEnd="8"
        class="anim"
        style="--parallax-speed:1.2; mix-blend-mode: hard-light;"
      >
        <img
          src="/img/factory/scribbles-2.jpg"
          style="width:100vw; min-height:50lvh; object-fit:cover; object-position: top;"
        />
      </Layer>
    ...
    "
      >
        <img
          src="/img/factory/messbed.jpg"
          style="width:100vw; height:80lvh; object-fit:cover;"
        />
      </Layer>
      <Layer
        overlap
...
<SectionWrap>
  <Layer
    ...
    colEnd="10"
    class="fade"
    style=" --fade-duration:2s; mix-blend-mode: screen;"
  >
    <img
      src="/img/factory/spin.webp"
      style="width:100vw; height: 100lvh; object-fit:cover;"
    />
  </Layer>
    ...
    <Layer minHeight="50lvh">
      <Textblock
        lines={[
          {
            indent: 0,
            text: `He began to grow furious that I kept contacting him,`,
          },
          {
            indent: 1,
            text: `and I danced in staccato rhythms to cast a spell`,
          },
  ...
  <LayerWrap>
    <Layer overlap colStart="5" colEnd="14" style=" mix-blend-mode: screen;">
      <img
        src="/img/factory/Family Photos.jpg"
        style="width:100vw; height: 80lvh; object-fit:cover;"
      />
    </Layer>
    ...
    <Layer
      ...
      colEnd="7"
      class="anim"
      style="--parallax-speed:1.4;"
    >
      <img
        src="/img/factory/poem-2.jpg"
        style="width:100vw; object-fit:cover;"
      />
    </Layer>
    <Layer minHeight="50lvh">
      <Textblock
        lines={[
          ...
          {
            indent: 1,
            text: `and the shows on the television were all about me.`,
          },
          {
            indent: 0,
            text: `I painstakingly organized the books on my shelf`,
          },
          {
            indent: 1,
            text: `To represent the intuitive knowledge granted to each class in a perfect system:`,
          },
        ]}
      />
    </Layer>
  ...
  <LayerWrap>
    <Layer
      ...
      colEnd="10"
      class="anim"
      style="--filter-end:hue-rotate(1000deg);"
    >
      <img
        src="/img/factory/bookshelf.jpg"
        style="width:100vw; height: 27rem;"
      />
    </Layer>
  ...
  <LayerWrap toggleVis>
    ...
    <Layer minHeight="50lvh">
      <Textblock
        lines={[
          ...
          {
            indent: 1,
            text: `where the universe repeated over and over again`,
          },
    ...
    <Layer minHeight="100lvh" x=".2">
      <Textblock
        lines={[{ indent: 0, text: `He begged me to let the universe end.` }]}
      />
    </Layer>
    <Layer
      minHeight="100lvh"
      class="anim"
      style="--parallax-speed:1.4; mix-blend-mode: color-burn; position:relative; z-index: 1000;"
    >
      <img
        src="/img/factory/poem-3_cropped.png"
        style="width:min(50vh, 100vw);"
      />
    </Layer>
    ...
    `}
      ...
      <LayerWrap toggleVis>
        ...
        <Layer minHeight="100lvh" style="position:relative; z-index:900; ba">
          <iframe
            style="aspect-ratio: 560 / 315; width: min(100vw, calc(75lvh/315*560));"
            src="https://www.youtube.com/embed/RAfHYaXmZEs?si=BndGvzg0KqJvyr5m"
...
<style type="text/css">
  .noizz {
    ...
    pointer-events: none;
    animation:
      calc(1s / var(--fps) * 2) steps(2, end) infinite alternate noizz-scalex
        both,
      calc(1s / var(--fps) * 3) steps(3, end) infinite alternate noizz-scalex
        both,
      calc(1s / var(--fps) * 5) steps(5, end) infinite alternate noizz-scalex
        both,
      calc(1s / var(--fps) * 7) steps(7, end) infinite alternate noizz-scalex
        both,
      calc(1s / var(--fps) * 2) steps(2, end) infinite alternate noizz-scaley
        both,
      calc(1s / var(--fps) * 3) steps(3, end) infinite alternate noizz-scaley
        both;
  ...
  @keyframes noizz-y {
    0% {
      transform: translateY(calc(var(--width) / 4 * -1));
    }
    100% {
