...
<SectionWrap class="intro" rootMargin="50%">
  <LayerWrap toggleVis>
    <Layer minHeight="100lvh" style="position:relative;">
      <img
        src="/img/train/nightbus_contrasty.jpg"
    ...
    <Layer
      fixed
      style="mix-blend-mode: screen; background: rgb(9 24 64); --fade-duration:2s;"
    />

    <Layer
      fixed
      class="fade"
      style="z-index: 5; mix-blend-mode: lighten;      --fade-duration: 1s;
"
    >
      <img
        src="/img/train/paintey.webp"
        style="width:100vw; height:100lvh; object-fit:cover;"
      />
    </Layer>
  ...
  <LayerWrap style="margin: 0 0 20lvh;">
    <Layer
      ...
      colEnd="8"
      class="anim"
      style="mix-blend-mode: hard-light; --parallax-speed:1.4;"
    >
    ...
    <Layer x=".7" y=".5" minHeight="120lvh">
      <Textblock
        lines={[
          ...
          {
            indent: 1,
            text: `I got so lonely that I hung out in the library all day.`,
          },
...
<SectionWrap rootMargin="0%">
  <img
    src="/img/train/painttracks.webp"
    style="
      position: absolute;
      min-height: 100lvh;
      min-width: 100vw;
  ...
  <Layer minHeight="100lvh" class="anim" style="--parallax-speed:1.2;">
    <Textblock
      lines={[
        ...
        {
          indent: 0,
          text: `crushing my bones and spreading my gore along the rails`,
        },
...
<SectionWrap rootMargin="0%">
  ...
  <LayerWrap toggleVis rootMargin="0%">
    <Layer
      fixed
      colEnd="9"
      style="mix-blend-mode: color-burn; z-index: -10; --fade-duration: 2s;"
    >
      <style type="text/css">
        @keyframes glitch-x {
          from {
          ...
          to {
            background-position-x: calc(
              100vh / (var(--x-frames) + 1) * var(--x-frames)
            );
          }
        }
        ...
        @keyframes glitch-y {
          ...
          to {
            background-position-y: calc(
              100vh / (var(--y-frames) + 1) * var(--y-frames)
            );
          }
        }
        ...
        .glitchy {
          ...
          animation:
            calc(var(--time) / 13 * var(--x-frames)) steps(var(--x-frames))
              infinite glitch-x both,
            calc(var(--time) / 17 * var(--y-frames)) steps(var(--y-frames))
              infinite glitch-y both;
        }
      </style>
    ...
    <Layer minHeight="100lvh" x=".6" y=".8">
      <Textblock
        lines={[
          ...
          {
            indent: 1,
            text: `“she saw a bird land on the track and pushed the emergency stop button”`,
          },
...
<SectionWrap rootMargin="0%">
  ...
  >
    <img
      src="/img/train/sunset.jpg"
      style="width: 100vw; height: calc(125lvh + 50lvh * var(--scroll-anim-toggle)); object-fit:cover;"
    />
  </Layer>
...
<style type="text/css">
  .traintitle {
    ...
    font-size: min(0.9vw, calc(13px + 0.1vw));
    --timeunit: 1ms;
    --strength: 0.1em;
    transform: skew(30deg, -8deg);
    animation:
      calc(var(--timeunit) * 997) steps(3) infinite traintitle_blur both,
