...
<SectionWrap>
  <Layer minHeight="100lvh" mColStart="2" mColEnd="13">
    <div class="clowntext">
      ...
      <p>
        I would have a credits page but I mostly did everything with the notable
        exception of the background tracks on pages 3,4, & 5 which were supplied
        by the talented <a href="https://soundcloud.com/mordecaimusician"
          >Justin Donaldson</a
        >
      </p>

      <p>
        This is somewhat embarassing to admit but parts of this project have
        been in the works for over a decade now, and I am so grateful to be in a
        position to finally share it
      </p>

      <p>
        If you'd like to hear about other projects or read my essays please sign
        up to my substack <a href="https://arcove.substack.com/">here</a>
      </p>
...
<style type="text/css">
  .bg {
    ...
    animation: calc(var(--frames) / var(--fps) * 1000ms)
      steps(calc(var(--frames) - 1)) 0s infinite alternate filmstrip;
  }
