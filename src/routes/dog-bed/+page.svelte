...
<SectionWrap>
  ...
  <Layer fixed style="mix-blend-mode: color-burn;" x="1">
    <img
      src="/img/dog-bed/collage-1.webp"
      style="
            min-width: 100vw;  
            height:120lvh;
            object-fit: cover;
  ...
  <LayerWrap>
    <Layer overlap colStart="2" colEnd="7">
      <img
        src="/img/dog-bed/collage-2.webp"
        style="
            width: 100vw;
        "
      />
    ...
    <Layer minHeight="100lvh">
      <Textblock
        lines={[
          ...
          {
            indent: 0,
            text: `Walls painted the particular color of his choosing`,
          },
        ]}
      />
    </Layer>
  ...
  <LayerWrap>
    <Layer
      overlap
      class="anim fade"
      style="--parallax-speed:1.25; margin-top: -50lvh;"
      x="1"
    >
      <img
        src="/img/dog-bed/collage-4.webp"
        style="
    ...
    <Layer overlap colStart="2" colEnd="13">
      <img
        src="/img/dog-bed/collage-3.webp"
        style="
            width: 100vw;
        "
      />
    ...
    <Layer minHeight="50lvh">
      <Textblock
        lines={[
          {
            indent: 0,
            text: `My boyfriend's mother offered to buy us a bedroom set`,
          },
          { indent: 0, text: "" },
...
<SectionWrap style="margin-bottom: 20lvh;" rootMargin="0px">
  <Layer
    ...
    class="anim"
    colEnd="13"
    style="--transform-y-end:-10lvh; z-index: -100;"
  >
    <img
      src="/img/dog-bed/noir.jpg"
      style="
            width: 100vw; 
            height: 110lvh; 
            object-fit: cover;
  ...
  <LayerWrap>
    <Layer
      ...
      colEnd="7"
      class="anim"
      style="--parallax-speed: 1.25; rotate:2deg;"
    >
    ...
    >
      <img
        src="/img/dog-bed/book.gif"
        style="width:100vw; image-rendering:pixelated;"
      />
    </Layer>
  ...
  <LayerWrap>
    ...
    <Layer
      ...
      colEnd="14"
      class="anim"
      style="--parallax-speed: 1.25; z-index:10;"
    >
...
<SectionWrap style="padding:10lvh 0">
  <Layer overlap>
    <img
      src="/img/dog-bed/meatmarket_processed.jpg"
      style="
                width: 100vw; 
                height: 120lvh; 
                object-fit: cover;
    ...
    <Layer minHeight="120lvh" x=".9">
      <Textblock
        lines={[
          ...
          {
            indent: 0,
            text: `on a blow-up mattress on the floor of my apartment`,
          },
